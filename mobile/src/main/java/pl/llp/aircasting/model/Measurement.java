...
/**
 * 
 * @author josephzuhusky EDITTED original Measurement type
 * to include String values for measurements...
 *
 */
public class Measurement {
	...
	@Expose
	private String value_string; // in case of non-double measurements
	@Expose
	private Date time;
	@Expose
	...
	public Measurement(String value, Date date) {
		this(0, 0, 0);
		this.value_string = value;
		setTime(date);
	}
	...
	public boolean equals(Object o) {
		...
		if (Double.compare(that.value, value) != 0)
			return false;
		//if (!that.value_string.equals(value_string))
		//	return false;
	...
	public String toString() {
		if (value != 0) {
			return "Measurement{" + "latitude=" + latitude + ", longitude=" + longitude + ", value=" + value + ", time="
					+ time + '}';
		} else {
			return "Measurement{" + "latitude=" + latitude + ", longitude=" + longitude + ", value=" + value_string
					+ ", time=" + time + '}';
		}
	}
