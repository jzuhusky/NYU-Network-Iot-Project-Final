...
public class Session implements Serializable {
	...
	Map<String, MeasurementStream> streams = newHashMap();

	@Expose
	private List<Note> notes = newArrayList();
	...
	public String toString() {
		return "Session{" + "id=" + id + ", title='" + title + '\'' + ", markedForRemoval=" + markedForRemoval
