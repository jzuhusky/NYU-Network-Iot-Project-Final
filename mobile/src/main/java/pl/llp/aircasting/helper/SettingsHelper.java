...
public class SettingsHelper {
	...
	public static final String DEFAULT_BACKEND = "35.166.101.45"; // CHANGED
	public static final int DEFAULT_BACKEND_PORT = 9002; // changed
	...
	private boolean isNumericPreference(String key) {
		return key.equals(CALIBRATION) || key.equals(OFFSET_60_DB) || key.equals(HEAT_MAP_DENSITY)
				|| key.equals(BACKEND_PORT) || key.equals(SAMPLE_INTERVAL);
	}
