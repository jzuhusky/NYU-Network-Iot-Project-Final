...
public class ActualSessionTracker implements SessionTracker {
	...
	ActualSessionTracker(EventBus eventBus, final Session session, DatabaseTaskQueue dbQueue,
			SettingsHelper settingsHelper, MetadataHelper metadataHelper, SessionRepository sessions,
