...
import pl.llp.aircasting.IOTExtension.KeepAliveService;
...
public final class Intents {
	...
	public static void startSensors(Context context) {
		...
		Intent i2 = new Intent(context, ExtendedSensorService.class);
	...
	public static void stopSensors(Context context) {
		...
		// ExtendedSensorService.class));
	}
	
	public static void startKeepAliveService(Context context) {
		Intent keepAliveServiceIntent = new Intent(context, KeepAliveService.class);
	...
	public static void restartSensors(Context context) {
		Intent intent = new Intent(context, SensorService.class);
		Intent i2 = new Intent(context, ExtendedSensorService.class);
		intent.putExtra(SESSION_SERVICE_TASK, RESTART_SENSORS);  // EDITTED BY JZ
		context.startService(i2);
		context.startService(intent);
	}
	 ...
	 *             When it's impossible to create the AirCasting directory
	 */
